...
export const faqData = [
  { q: 'Как оформить заказ?', a: 'Откройте пост поставщика. Перейдите по ссылке. Изучите ассортимент. Свяжитесь с поставщиком напрямую. Согласуйте заказ, доставку и оплату.' },
  { q: 'Подписка оплачивается один раз или каждый месяц?', a: 'Подписка является ежемесячной. Продлевая подписку, вы сохраняете доступ к ежедневным обновлениям.' },
  { q: 'Почему доставка платная?', a: 'Мы не занимаемся доставкой товаров. Стоимость доставки устанавливают транспортные компании.' }
];
